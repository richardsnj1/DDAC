...
namespace DDAC.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<DDACUser> _signInManager;
        private readonly UserManager<DDACUser> _userManager;
        private readonly IUserStore<DDACUser> _userStore;
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "You must enter the email first before submitting your form!")]
            [EmailAddress]
            [Display(Name = "Email")]
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "You must enter the password first before submitting your form!")]
        ...
        private DDACUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<DDACUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(DDACUser)}'. " +
                    $"Ensure that '{nameof(DDACUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<DDACUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<DDACUser>)_userStore;
        }
    }
}
